...
"""
NOTES:
so far i know that you can acess the title and instructions using satisfaction_survey.title/instructions
to get acess to the questions for q in satisfaction_survey.questions: q.question + q.choices gets the question
and the choices that are for that question. 
"""